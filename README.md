...
- **AI 学习导师**：首页与题内均提供“小基”文字导师，可按需读取学情、检索知识和解释已提交结果；首页回答相关技能问题后附具体关卡推荐，点击即可进入训练；比赛进行中不会提示答案。
...
仓库内 `data/initial-question-sets.json` 固定提供 10 个能力、70 个关卡、650 道 V1 题，当前题型分布为 205 道选择题、368 道矩形框、51 道多边形和 26 道文本实体，其中 436 道带图片、419 道为图片标注题。每个课关前至少 2 道、每个岗关前至少 10 道均为图片标注题，每个赛关的 10 道题全部为图片标注题；选择题、实体题等其他题型统一排在图片标注题之后。
