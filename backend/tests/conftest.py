...
from backend.db import engine, cache, User, Run, Progress, Mistake, TaskCard, JobLearning, QuestionSet, password_hash, now
...
def account_factory():
    ...
    for account in accounts:
        ...
        with Session(engine) as db:
            for model in (Mistake, JobLearning, TaskCard, Progress, Run, User):
